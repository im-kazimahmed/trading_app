...
(86, 'seo.data', '{\"seo_image\":\"1\",\"keywords\":[\"forex\",\"Trading platform\",\"Online Trading\",\"Cryptocurrency\",\"Trading tools\",\"Web-based trading\",\"Real-time market data\"],\"description\":\"TradingApp is a unique trading platform. You can make real-time transactions whenever and wherever you like. The platform can be accessed not only from a PC but also from a full-service mobile. It\'s easily installable, controllable through the admin panel, and comes with a responsive design, high security, and interactive User interface. support plugins, LiveChat, Google ReCaptcha, analytics, automatic payment gateway, cards, currencies, and cryptos.\",\"social_title\":\"TradingApp\",\"social_description\":\"TradingApp is a unique trading platform. You can make real-time transactions whenever and wherever you like. The platform can be accessed not only from a PC but also from a full-service mobile. It\'s easily installable, controllable through the admin panel, and comes with a responsive design, high security, and interactive User interface. support plugins, LiveChat, Google ReCaptcha, analytics, automatic payment gateway, cards, currencies, and cryptos.\",\"image\":\"63f339b48607f1676884404.png\"}', '2021-04-28 00:49:34', '2023-02-20 09:15:30'),
