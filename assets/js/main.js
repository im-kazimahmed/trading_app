(function ($) {
  ...
  $(document).ready(function () {
    ...
    if (currentUrl.includes('faq') || currentUrl.includes('services') || currentUrl.includes('contact') || currentUrl.includes('blog')) {
      $(".header-area .menu li a").css('color', '#ffffff')
      $(".header-top ul li a").css('color', '#ffffff')
      $(".header-top ul li").css('color', '#ffffff')
    }
    ...
    $(window).on('scroll', function () {
      if ($(this).scrollTop() < 1) {
        ...
        $(".header-area .menu li a").css('color', '#33406a')
