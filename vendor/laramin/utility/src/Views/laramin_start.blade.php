...
<head>
	...
	<title>@lang('Easy Activator by Kazim Ahmed')</title>
...
<body>
	...
	<footer class="py-3 text-center bg--dark border-top border-primary">
		<div class="container">
			<p class="m-0 font-weight-bold">&copy;<?php echo Date('Y') ?> - @lang('All Right Reserved by') <a href="https://kazimahmed.com/">@lang('KazimAhmed')</a></p>
		</div>
	</footer>
